...
- **New Eden Atlas:** searchable star map with security, hourly activity, stations and agents; **Missions & LP** offers agent discovery, route handoff, mission-reference links, private pilot LP balances, and searchable rewards. [Setup, sources and limitations](docs/navigation-atlas.md).
