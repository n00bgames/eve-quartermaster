...
export function KillboardPage({ api }: { api: ApiClient }) {
  ...
  return <div className="killboard-page">
    ...
    <div className="killboard-placard"><AlertTriangle size={18} /><span>{context.coverage_notice} Do not interpret discovery coverage as a complete combat record.</span></div>
