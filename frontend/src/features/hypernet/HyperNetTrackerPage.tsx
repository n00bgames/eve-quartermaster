...
export function HyperNetTrackerPage({ api }: { api: ApiClient }) {
  ...
  return <div className="hypernet-page">
    ...
    {side === "buyer" && <p className="muted">Expired bids are fully refunded and kept in history. They do not affect bid exposure, spend, win rate, luck, or ROI statistics.</p>}
