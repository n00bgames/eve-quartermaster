...
export type FittingSimulationStats = {
  math_engine_requested?: "python" | "shadow" | "rust";
  math_engine_used?: "python" | "python-shadow" | "python-shadow-error" | "python-fallback" | "rust";
  math_engine_shadow_match?: boolean | null;
...
export type FittingSimulation = { fitting_id: number; character_id: number; character_name: string; dogma_loaded: boolean; dogma_effects_loaded?: boolean; resource_engine_requested?: "python" | "shadow" | "rust"; resource_engine_used?: "python" | "python-shadow" | "python-shadow-error" | "python-fallback" | "rust"; resource_engine_shadow_match?: boolean | null; math_engine_requested?: "python" | "shadow" | "rust"; math_engine_used?: "python" | "python-shadow" | "python-shadow-error" | "python-fallback" | "rust"; math_engine_shadow_match?: boolean | null; stats_engine_requested?: "python" | "shadow" | "rust"; stats_engine_used?: "python" | "python-shadow" | "python-shadow-error" | "python-fallback" | "rust"; stats_engine_shadow_match?: boolean | null; heat?: boolean; implant_context?: FittingSimulationImplantContext | null; status: "pass" | "warning" | "unknown"; summary: { missing_skills: number; slot_issues: number; resource_issues: number }; resources: { cpu: FittingSimulationResource; powergrid: FittingSimulationResource; calibration: FittingSimulationResource }; slots: FittingSimulationSlot[]; requirements: FittingSimulationRequirement[]; stats?: FittingSimulationStats | null; notes: string[] };
