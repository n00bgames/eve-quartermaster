...
export type NavigationRouteSystem = NavigationSystem & { jump_index: number; recent_kill_count?: number | null; recent_destroyed_value?: number | null; latest_killmail_time?: string | null; risk_score?: number | null; risk_label?: string | null; sample_killmails?: NavigationKillmailSample[] };
...
export type NavigationRoute = { origin: NavigationSystem; destination: NavigationSystem; jump_count: number; systems: NavigationRouteSystem[]; highsec_count: number; lowsec_count: number; nullsec_count: number; shortest_known: boolean; prefer_safer?: boolean; routing_preference?: string; avoided_system_ids?: number[]; map_context?: OperationalMapContext; gatecheck?: NavigationGatecheck };
