...
export type AssetPagePayload = { items: Asset[]; total: number; page: number; page_size: number };

export type Asset = { id: number; ownership_entity_id: number; owner_name: string; owner_kind?: string; type_id: number; type_name: string; quantity: number; location_name?: string; location_id?: number | null; location_flag?: string; location_flag_name?: string | null; source: string; last_synced_at?: string | null; parent_asset_item_id?: number; parent_asset_type_name?: string; is_blueprint_copy?: boolean | null; inventory_family?: string | null; inventory_subtype?: string | null; type_group_id?: number | null; type_group_name?: string | null; type_category_id?: number | null; type_category_name?: string | null; type_market_group_id?: number | null };

export type Blueprint = { id: number; asset_id?: number | null; owner_name: string; blueprint_type_id: number; blueprint_type_name: string; product_type_id?: number | null; product_type_name?: string; material_efficiency: number; time_efficiency: number; runs_remaining?: number; is_copy: boolean; location_name?: string; location_id?: number | null; last_synced_at?: string | null; active_use?: { active?: boolean; activity?: string | null; status?: string | null; job_id?: number | null; runs?: number | null; facility?: string | null; installer?: string | null; start_date?: string | null; end_date?: string | null } | null; inventory_state?: string | null; research_shadow?: boolean; inventory_family?: string | null; inventory_subtype?: string | null; capital_construction_related?: boolean; blueprint_group_id?: number | null; blueprint_group_name?: string | null; blueprint_category_id?: number | null; blueprint_category_name?: string | null; product_group_id?: number | null; product_group_name?: string | null; product_category_id?: number | null; product_category_name?: string | null; product_market_group_id?: number | null };
